    ...
    <div className="flex flex-col items-center justify-center space-y-16 py-12">
      ...
      >
        <div className="inline-flex items-center space-x-2 rounded-full border border-zinc-800 bg-zinc-900/60 px-4 py-1.5 text-xs font-medium text-zinc-300 backdrop-blur-md">
          ...
          <span>Distributed Build Architecture v1.0 • Phase 1 Live</span>
        </div>
        ...
        <p className="text-lg text-zinc-400 max-w-2xl mx-auto leading-relaxed">
          Surpassing legacy deployment tools with absolute architectural transparency. Built on Docker build containers, BullMQ Redis queues, least-privilege GitHub Apps, and pure Glassmorphism aesthetics.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full pt-8">
        <GlassCard hoverEffect className="space-y-4">
          ...
          <h3 className="text-lg font-bold text-white">Isolated Docker Engine</h3>
          <p className="text-sm text-zinc-400 leading-relaxed">
            Every build executes inside ephemeral Docker containers (`node:20-alpine`) guaranteeing complete filesystem isolation and eliminating noisy-neighbor interference.
          </p>
        </GlassCard>
        ...
        <GlassCard hoverEffect className="space-y-4">
          ...
          <h3 className="text-lg font-bold text-white">BullMQ & Redis Brokers</h3>
          <p className="text-sm text-zinc-400 leading-relaxed">
            Decoupled API control plane and workers. Incoming deploy requests are queued instantly in Redis, preventing server timeouts during concurrent build surges.
          </p>
        </GlassCard>
        ...
        <GlassCard hoverEffect className="space-y-4">
          ...
          <h3 className="text-lg font-bold text-white">Least-Privilege GitHub Apps</h3>
          <p className="text-sm text-zinc-400 leading-relaxed">
            No global account scopes. Users select exact repositories via fine-grained GitHub Apps with rotating 1-hour installation access tokens (`ghs_token`).
          </p>
        </GlassCard>
      </div>
      ...
      <GlassCard className="w-full space-y-6 border-zinc-800/90 bg-zinc-900/60">
        <div className="flex items-center justify-between border-b border-zinc-800/60 pb-4">
          <div className="flex items-center space-x-3">
            ...
            <span className="font-bold text-white tracking-wide">NetLaunch Distributed Request Flow</span>
          </div>
          <span className="text-xs font-mono text-zinc-500">Latency: ~12ms Control Plane</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 text-center font-mono text-xs">
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/80 p-4 space-y-2">
            ...
            <div className="font-bold text-white">Git Push / UI</div>
          </div>
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/80 p-4 space-y-2">
            <div className="text-zinc-500">2. Control Plane</div>
            <div className="font-bold text-white">Express / Prisma</div>
          </div>
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/80 p-4 space-y-2">
            <div className="text-zinc-500">3. Queue Broker</div>
            <div className="font-bold text-emerald-400">Redis BullMQ</div>
          </div>
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/80 p-4 space-y-2">
            <div className="text-zinc-500">4. Build Worker</div>
            <div className="font-bold text-blue-400">Docker Container</div>
          </div>
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/80 p-4 space-y-2">
            <div className="text-zinc-500">5. CDN Ingress</div>
            <div className="font-bold text-white">*.netlaunch.app</div>
          </div>
        </div>
      </GlassCard>
    </div>
